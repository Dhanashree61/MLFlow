...
mlflow.set_tracking_uri("mlflowtesting")
print('MLflow tracking using uri :',mlflow.get_tracking_uri())
# 
# exp = mlflow.set_experiment(experiment_name='Experiment2')
exp_id =  mlflow.create_experiment(name='Exp111',tags={"Importance":1,"country":"India"})
get_exp = mlflow.get_experiment(exp_id)
print('Name',get_exp.name)
print('Name',get_exp.tags)
